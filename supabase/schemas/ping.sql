...
ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."ping_id_seq" START
    WITH
        1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1
);

ALTER TABLE ONLY "public"."ping" ADD CONSTRAINT "ping_pkey" PRIMARY KEY ("id");

CREATE POLICY "Enable read access for all users" ON "public"."ping" FOR
SELECT
    USING (true);
